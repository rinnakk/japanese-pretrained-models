...
""" Tokenization class for model RobertaJapanese."""
...
PRETRAINED_VOCAB_FILES_MAP = {
    "vocab_file": {
        "rinna/japanese-roberta-base": "https://huggingface.co/rinna/japanese-roberta-base/resolve/main/spiece.model",
    }
}
...
PRETRAINED_POSITIONAL_EMBEDDINGS_SIZES = {
    "rinna/japanese-roberta-base": 512,
}


class RobertaJapaneseTokenizer(PreTrainedTokenizer):
    """
    Construct a RobertaJapanese tokenizer. Based on [SentencePiece](https://github.com/google/sentencepiece).
        ...
        if extra_ids > 0 and additional_special_tokens is None:
            ...
            if extra_tokens != extra_ids:
                raise ValueError(
                    ...
                    " provided to RobertaJapaneseTokenizer. In this case the additional_special_tokens must include the extra_ids"
                    " tokens"
                )
    ...
    def create_token_type_ids_from_sequences(
        ...
        """
        Create a mask from the two sequences passed to be used in a sequence-pair classification task. RobertaJapanese does not make
        ...
        return len(cls + token_ids_0 + token_ids_1) * [0]
